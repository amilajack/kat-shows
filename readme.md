...
=============================
[![Build Status](https://travis-ci.org/t3chnoboy/kat-shows.svg?branch=master)](https://travis-ci.org/t3chnoboy/kat-shows)
[![NPM version](https://badge.fury.io/js/kat-shows.svg)](http://badge.fury.io/js/kat-shows)
[![Dependency Status](https://img.shields.io/david/t3chnoboy/kat-shows.svg)](https://david-dm.org/t3chnoboy/kat-shows)
[![npm](https://img.shields.io/npm/dm/kat-shows.svg?maxAge=2592000)]()
...
Install using npm:
```bash
npm install kat-shows --save
```

## Usage

```javascript
const PirateBay = require('kat-shows')
```
...
[
  {
    ...
    size: '4.17 GiB',
    link: 'http://kat-shows.se/torrent/10013794/Game_of_Thron...'
...
output:
  {
    ...
    link: 'http://kat-shows.se/torrent/10676856/',
    id: '10676856',
